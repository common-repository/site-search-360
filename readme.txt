...
Site Search 360 replaces your standard WordPress search by a fast and precise on-site search on all your posts and pages. Site Search 360 is highly customizable and gives you [detailed insights](https://app.sitesearch360.com/) into search behavior.
...
* Easily customizable by CSS and the [dashboard](https://app.sitesearch360.com/).
...
4. Optionally, configure the search in your WordPress backend. Indexing settings and analytics can be seen at your  [dashboard](https://app.sitesearch360.com/).
...
If you need more flexibility when indexing custom fields, you can select the *Crawler indexing* option and customize the indexing behavior in the [Site Search 360 Control panel](https://app.sitesearch360.com).  
...
= 2.1.4 =
* Improved search designer integration.
* Improved compatibility with WP Rocket.

= 2.1.3 =
* Fix migrating callbacks.
* Add debug log if migration fails.
* Add fallback code if migration fails.
* Add authentication expired warning.
...
= 2.1.1 =
* Upgrade search script to v14.
* Add Indexing section.
* Replace configuration pages with new Search Designer interface.
* Improved WooCommerce indexing.
